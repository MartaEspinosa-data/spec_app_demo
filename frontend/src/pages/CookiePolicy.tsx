                ...
                <div className="space-y-8 text-gray-600 leading-relaxed font-medium">
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                <h3 className="font-bold text-indigo-600 mb-1">Cookies de Terceros (Stripe/Google)</h3>
                                <p className="text-sm text-gray-600">
                                    Utilizamos servicios de <strong>Stripe</strong> para pagos seguros y <strong>Google</strong> para el inicio de sesión (OAuth) y visualización de vídeos (YouTube). Estos servicios pueden instalar sus propias cookies para prevenir fraude o recordar preferencias.
                                </p>
                            </div>
                        </div>
                    </section>
